            ...
            <div className="px-3 lg:px-0 my-25">
                <Container>
                    ...
                    <div className="flex lg:items-center justify-center gap-x-5 lg:gap-x-20 pt-20">
                        <Heading className={'text-base text-darkText  font-medium relative group'} text={<><span className="w-0 h-[2px] bg-darkText  group-hover:w-full absolute left-0-0 bottom-0  transition-all duration-500"></span><span>DESCRIPTION</span></>} as={'h4'}/>
                        <Heading className={'text-base text-darkText  font-medium relative group'} text={<><span className="w-0 h-[2px] bg-darkText  group-hover:w-full absolute left-0-0 bottom-0  transition-all duration-500"></span><span>ADDITIONAL INFORMATION</span></>} as={'h4'}/>
                        <Heading className={'text-base text-darkText  font-medium relative group'} text={<><span className="w-0 h-[2px] bg-darkText  group-hover:w-full absolute left-0-0 bottom-0  transition-all duration-500"></span><span>REVIEWS (3)</span></>} as={'h4'}/>                                
                    </div>
