      ...
      <div className='flex justify-between flex-col lg:flex-row pt-5'>
        ...
        <div className=" lg:w-[24%]">
          ...
          <div className="flex items-center gap-x-3 pt-5">
            <input className='px-4 lg:px-6 py-2 text-white text-xs lg:text-base placeholder:text-lightText border-accent border-2 rounded placeholder:text-base focus:outline-0' type="text" placeholder='Email Address for Newsletter' />
